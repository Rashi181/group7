...
public:
    ...
    std::vector<uint32_t> apply_data_reduction();
    bool is_simplicial(uint32_t v) const;
    bool is_almost_simplicial(uint32_t v) const;
    void eliminate_vertex_simple(uint32_t v, std::vector<uint32_t>& ordering);
